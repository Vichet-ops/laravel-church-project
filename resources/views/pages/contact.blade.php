<x-layout title="Contact">
    ...
    <div class="relative h-64 md:h-80 lg:h-96 flex items-center justify-center pt-48 pb-20 md:pb-12">
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center justify-center h-full">
            <h1 class="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Contact Us</h1>
            <p class="text-xl md:text-2xl text-gray-600 max-w-6xl mx-auto">
                We'd love to hear from you. Reach out for questions, prayer requests, or more info.
            </p>
        </div>
    </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12">
                ...
                <div class="space-y-8">
                    <div>
                        ...
                        <p class="text-lg text-gray-600 mb-8">
                            Whether you're looking to join our community, need prayer, or have questions about our services, we're here to help.
                        </p>
                    </div>
                    ...
                    <div class="space-y-6">
                        <!-- Address -->
                        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-gray-600 hover:shadow-xl transition-shadow duration-300">
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-600 hover:shadow-xl transition-shadow duration-300">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">info@gracebrethrenchurch.com</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-600 hover:shadow-xl transition-shadow duration-300">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">Monday - Friday: 9:00 AM - 5:00 PM<br>Sunday: 8:00 AM - 12:00 PM</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                    ...
                    <form class="space-y-6">
                        ...
                        <button type="submit" 
                                class="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-4 px-6 rounded-lg hover:from-blue-700 hover:to-blue-800 transition duration-300 font-semibold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                            Send Message
                        </button>
                    </form>
                </div>
